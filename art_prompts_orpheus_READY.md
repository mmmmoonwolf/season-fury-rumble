# ORPHEUS — prompt พร้อมวาง (ต่อ style anchor ให้แล้วทุกอัน)

**เจนตามลำดับนี้** คลิปก่อน แล้วค่อย A -> G
ท่ายืนผ่านด่านสัดส่วนไปแล้ว (2.76 หัว) ไม่ต้องเจนซ้ำ

> ⛔ **ห้ามวาดไฟในภาพทุกชีต** ไฟเป็นสถานะชั่วคราว เกมวาดเอง
> ถ้าอบไฟมาในภาพ ต้องวาดท่าฟาดสองชุด (ตอนติดไฟ/ไม่ติด) เปลืองเท่าตัว

---

## 1. ขั้น 1 — คลิป ยืน → วิ่ง
...
## 3. ชีต B — Riff ไล่หวดกีตาร์ (9 ท่า · 3 แถวแถวละ 3)

**ตัวชูโรงของตัวนี้** กดรัวแล้วหวดรัว 5 จังหวะต่อเนื่อง ฟาดวงกว้าง ไม่ใช่จิ้มทีละที 9 ท่านี้ = 5 จังหวะ + ท่าเชื่อม (บางจังหวะใช้ 2 ท่า บางจังหวะใช้ท่าเดียว)
...
## 6. ชีต E — สกิล 1 · Power Slide สไลด์เข่า (6 ท่า · 2 แถวแถวละ 3)
...
## 7. ชีต F — สกิล 2 · Blaze จุดไฟที่กีตาร์ (6 ท่า · 2 แถวแถวละ 3)
...
## 8. ชีต G — สกิล 3 อัลติ · Burn the House Down (6 ท่า · 2 แถวแถวละ 3)

ตั้งวงโซโล่ 4 วินาที · **เดินโซโล่ได้** ดังนั้น **สามท่าสุดท้ายต้องเป็นท่าย่างเท้า** ไม่ใช่ท่ายืนนิ่งทั้งหมด ไม่งั้นเวลาเดินจะเห็นตัวไถไปกับพื้น
