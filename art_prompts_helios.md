...
## ⛔ ด่านแรก: ท่ายืนต้องผ่านก่อน ห้ามเจนอย่างอื่น

อาร์ตที่ส่งมาสองรอบเป็น**สัดส่วนคนจริง** ซึ่งคนละทางกับ Nyx ที่เป็น chibi หัวโต

| | ตัวสูง | หัวกว้าง | อัตราส่วน |
|---|---|---|---|
| Nyx (เป้าหมาย) | 628 | 237 | **2.65** |
| ที่ได้มา (ทั้งสองรอบ) | 753 | 207 | **3.64** |

ห่างกัน 37% — ย่อให้สูงเท่ากันที่ขนาดในเกม (242 px) แล้วดูเหมือนมาคนละเกม

**ตัวละครนี้ต้องใช้ ~59 ท่า** ถ้าเจนทั้งหมดก่อนแก้สัดส่วน = ต้องทำใหม่ทั้งชุด
เจนท่ายืนให้ผ่านก่อนแล้วค่อยไล่ตามลำดับข้างล่าง ทุกชีตใช้ท่ายืนที่ผ่านแล้วเป็น reference

**วิธีเช็กว่าผ่าน:** ส่งมา เดี๋ยววัดให้ ต้องได้อัตราส่วน **2.5-2.8**
...
## 0. ท่ายืน (ด่านแรก — ภาพเดี่ยว)

**แนบ 2 อัน:** เฟรม `idle` ของ Nyx จาก atlas จริง + ภาพตัวละครที่มีอยู่
