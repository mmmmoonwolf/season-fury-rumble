...
> ⚠️ **อัปเดต: โหมด 1v1 ถูกลบแล้ว** เหลือแต่ SCRAMBLE ซึ่งมี Nyx ตัวเดียว
> ตาราง 4 ตัวข้างล่าง (Dear / March / KunJae / Bomb) เป็น**ของโหมดที่ลบไปแล้ว** อาร์ตไม่อยู่ในรีโปอีกต่อไป
> เก็บไว้เป็นบันทึกกติกาการสั่งอาร์ตที่ยังใช้ได้ (ส่วนที่ 1 ใช้ได้ทุกตัว) ไม่ใช่สถานะปัจจุบันของเกม
>
> - ตัวละครที่อยู่ในเกมตอนนี้: **Nyx เท่านั้น** — ดูหัวข้อ 2.5
> - จะทำ Dear / KunJae / OAT ขึ้นใหม่บนเอนจิน SCRAMBLE: ดีไซน์สกิลเดิมอยู่ที่ `docs/OLD_MODE_SKILLS.md`
