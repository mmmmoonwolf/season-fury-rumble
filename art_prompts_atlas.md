...
## สถานะอาร์ต (อัปเดตล่าสุด)

ชีต **A B C D E F G ได้ครบแล้ว** แยกออกมาได้ 54/54 ท่า
**ท่ายืนได้แล้ว** (atlas_idle_APPROVED.jpg) ประกอบขึ้นเกมแล้วทั้งหมด

เหลืออย่างเดียวคือ **ท่าวิ่งจากคลิป** ข้างล่างนี้
ระหว่างรอ ท่าวิ่งยืมสองจังหวะย่างของชีต E ไปก่อน ซึ่งเป็นท่าถลาก้มต่ำ
เตี้ยกว่าท่ายืน 40-60 px เห็นได้ว่าตัวหดตอนวิ่ง และดาบถูกลำตัวบัง
ได้คลิปเมื่อไหร่แก้บรรทัดเดียวใน `tools/build_scramble_atlas.py` แล้วรันใหม่
