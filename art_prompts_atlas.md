...
ชีต **A B C D E F G** · **ท่ายืน** · **คลิปท่าวิ่ง** ได้ครบทุกชิ้น
ประกอบเป็น 65 เฟรมในเกมเรียบร้อย ไม่มีอะไรค้างแล้ว

| ชิ้น | ได้จาก | ใช้ทำอะไร |
|---|---|---|
| ท่ายืน | atlas_idle_APPROVED.jpg | idle + ตั้งความสูง 240 |
| คลิป | atlas_clip/run_01-10.png | ท่าวิ่ง 10 เฟรม (รอบเต็ม 25 เฟรมจากคลิป 24fps) |
| ชีต A-G | atlas_sheets/ | ท่าที่เหลือทั้งหมด |
