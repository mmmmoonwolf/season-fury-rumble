...
ชีต **A B C D E F G ได้ครบแล้ว** แยกออกมาได้ 54/54 ท่า ประกอบขึ้นเกมแล้ว
เหลืออย่างเดียวคือ **คลิป ยืน → วิ่ง** ข้างล่างนี้

ระหว่างรอคลิป ท่ายืนยืมท่าสุดท้ายของชีต E (ยืนคุมเชิง ดาบทอดต่ำ) ไปก่อน
และท่าวิ่งยืมสองจังหวะย่างของชีต E — ได้คลิปเมื่อไหร่แก้แค่สองบรรทัดใน
`tools/build_scramble_atlas.py` แล้วรันใหม่
