...
หน้ากากปิดหน้ามิด = วัดจากโทนผิวไม่ได้ ให้ดู**ค่าจากผม**เป็นหลัก
แล้ว build ออกมาวัดความสูงเฟรมจริงเทียบท่ายืนเสมอ — ท่าตั้งหลักต้องได้ 96-100% ท่าพุ่ง/ย่อต่ำกว่านั้น
