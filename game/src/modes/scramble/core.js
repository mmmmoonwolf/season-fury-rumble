...
const STAGE = {
  ...
  // ห้าชั้นตามอาร์ตของเวที — ไล่จากล่างขึ้นบน
  //
  // ช่องว่างระหว่างชั้นต้องกระโดดถึงด้วยการกระโดดครั้งเดียว
  // แรงกระโดด 20 กับแรงโน้มถ่วง 0.95 ขึ้นได้ 20^2/(2*0.95) = 210 px
  // ช่องจริง: 158 / 110 / 104 / 88 — ผ่านทุกช่วง ไม่ต้องพึ่งดับเบิลจัมพ์
  //
  // ชั้นบนสุดสูงพอที่หัวตัวละครจะไปทับแถบ HUD (สูง 130 px · เท้า 160 = หัวอยู่ที่ 30)
  // ตั้งใจให้เป็นที่เสี่ยง ไม่ใช่ที่ปลอดภัย — ยืนบนนั้นแลกด้วยการมองไม่เห็นหลอดเลือดตัวเอง
  platforms: [
    { x1: 490, x2: 790, y: 462 },     // ชั้น 2 กลาง
    { x1: 110, x2: 430, y: 352 },     // ชั้น 3 ซ้าย
    { x1: 850, x2: 1170, y: 352 },    // ชั้น 3 ขวา
    { x1: 470, x2: 810, y: 248 },     // ชั้น 4 กลาง
    { x1: 530, x2: 750, y: 160 },     // ชั้น 5 บนสุด (แคบที่สุด)
  ],
};
