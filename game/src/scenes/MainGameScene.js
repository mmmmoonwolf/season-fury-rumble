...
export class MainGameScene extends Phaser.Scene {
  ...
  create() {
    ...
    // ออนไลน์: บังคับแมพแรกเสมอ (ปุ่ม M ถูกปิดตอนออนไลน์ — ดู _setupInput) กันแมพไม่ตรงกันระหว่าง host/guest
    this.levelKey = this.isOnline ? LEVEL_ORDER[0] : this.registry.get("levelKey") ?? LEVEL_ORDER[0];
