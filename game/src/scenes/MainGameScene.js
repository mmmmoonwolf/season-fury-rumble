...
export class MainGameScene extends Phaser.Scene {
  ...
  _setupInput() {
    ...
    // (v35: เคยย้ายกันไป B ชั่วคราวให้ B1989/Nyx ใช้ปุ่ม S ค้าง+กระโดดเป็นท่าพิเศษ — ยกเลิกท่านั้นแล้ว
    // ตามที่ขอ "อยากให้ปุ่ม WASD เหมือนคนอื่น" กันเลยย้ายกลับมา S เหมือนเดิมทุกตัวละคร)
