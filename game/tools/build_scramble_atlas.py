...
SEQ = {
    ...
    "jump":        ("A", [2, 3, 4, 5], AIR),
    # ท่านั่งเอามาจากชีต C ไม่ใช่ชีต A — วัดแล้วท่า A1 ที่ตั้งใจให้เป็นท่านั่ง
    # เตี้ยลงจากท่ายืนแค่ 4.8% (95.2%) คือแทบไม่ย่อเลย ผู้เล่นรายงานว่า "ไม่มีท่านั่ง"
    # C7 (ย่อต่ำมือยันพื้น) อยู่ที่ 73.8% ตรงกับตัวอื่น (Nyx 75% · Helios 83% · Alecto 83%)
    "crouch":      ("C", [7], GROUND),
    "hurt":        ("A", [6], GROUND),
