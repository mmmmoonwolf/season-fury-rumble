...
// ── โครงสร้างแมพ Sakura Heights (โหมด platform, blockout) — sanity check ──
{
  const L = SAKURA_HEIGHTS;
  ok(L.worldWidth === 2200 && L.worldHeight === 950, "ขนาด world ตรงกับ diagram ที่ให้ผู้ใช้ไปแล้ว (2200x950)");
