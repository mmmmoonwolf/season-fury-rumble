...
SEQ = {
    ...
    "gjab2": ("J", [4, 2, 3], GROUND),
    "gjab3": ("J", [5, 3, 6], GROUND),      # เงื้อ -> ยิง -> แตะปีกหมวก (ไม้จบปักเท้ายิง)
    "gside": ("J", [2, 3, 1], GROUND),      # เดินยิง — เห็นแค่ตอนหยุดนิ่ง ปกติวาดเป็นวงจรเดิน
    "gup":   ("J", [5, 5, 6], GROUND),      # เงยยิงสวนคนกระโดด
    "gdown": ("J", [4, 4, 2], GROUND),      # ย่อยิงต่ำ

    # ---- สกิล 1 Gunslinger: สลับแส้ <-> ไรเฟิล ----
    # ใช้ท่าเดียวทั้งสองทิศทางการสลับ (16 เฟรม สั้นเกินกว่าจะรู้สึกว่าไม่ตรง)
    "swap1": ("J", [6, 1, 1], GROUND),      # แตะปีกหมวก -> ยกปืนขึ้นพร้อม

    # ---- ท่าเดินถือปืน: ใช้ตอนถือไรเฟิลแล้วเดินยิงจริง ----
    # ถ้าไม่มีอันนี้ เธอจะไถไปกับพื้นเพราะเฟรมท่ายิงเป็นท่ายืนนิ่ง
    # เป็นเรื่องของการวาดล้วน ๆ ไม่แตะ sim
    "runGun": ("I", [1, 2, 3, 4], GROUND),
    # ยืนถือปืน: ไม่งั้นตอนสลับเป็นไรเฟิลแล้วยืนเฉย ๆ เธอจะถือแส้อยู่จนกว่าจะยิง
    "idleGun": ("J", [1], GROUND),
