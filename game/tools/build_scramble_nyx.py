...
SEQ = {
    ...
    # ท่า 5 ในชีตมีของยาวโค้งที่ดูเหมือนดาบอีกเล่มตอนดูภาพนิ่ง แต่ในเกมมันโชว์แค่ 4 เฟรม (67 ms)
    # ที่ขนาดจริงกับความเร็วจริงมันอ่านเป็น "เส้นฟันกวาด" ไม่ใช่การเปลี่ยนอาวุธ — ยืนยันจากภาพในเกมแล้ว
    # บทเรียน: เฟรมโจมตีต้องตัดสินจากภาพในเกม ไม่ใช่จากชีตขยาย ภาพนิ่งทำให้ตัดของที่ใช้ได้ทิ้ง
    "curse2": ("@curse_sheet", [4, 5, 6]),   # ย่อลงจากการวาร์ป -> ฟันสวนขึ้น -> ยืดตัวจบท่า
