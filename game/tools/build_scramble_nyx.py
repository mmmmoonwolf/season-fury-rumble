...
SEQ = {
    ...
    "down": ("@sweep_sheet", [1, 3, 5]),          # เงื้อ -> กวาดสุดแขน -> ชักกลับ
...
CLIP_STANDING_PX = {
    "@block_sheet": 585,
    # 724 คือค่าที่วัดใบหน้าได้ แต่ภาพนี้มีกำปั้นกับดาบบังหน้าอยู่ ค่าจึงต่ำกว่าจริงเท่าตัว
    # (build ออกมาแล้วตัวสูง 162% ของท่ายืน ทั้งที่เป็นท่านั่งยอง) แก้จากขนาดที่ได้ในเกมจริง:
    # 724 x (211 ที่ได้ / 99 ที่ต้องการ) = 1551 -> ท่าก้มกันสูงเท่าท่าย่อพอดี
    "@blockcrouch_sheet": 1551,
    "@rise_sheet": 834,
    "@spin_sheet": 433,
    "@sweep_sheet": 537,
    "@dive_sheet": 589,
