...
SEQ = {
    ...
    # ---- ชีต H: ไม้จบยัดหีบ ----
    # H2 กับ H6 เป็นท่าที่หีบหลุดออกจากมือไปแล้ว ตัวแยกจึงทิ้งหีบทิ้งไปเอง เหลือแค่ตัว
    # ซึ่งพอดีกับที่ต้องการ: jab4 คือ "คว้า" ถ้าคว้าไม่โดนก็ค้างอยู่แค่ท่าลุงจ์ ไม่มีหีบให้ยัด
    "jab4": ("H", [1, 2, 2], GROUND),      # ลากหีบออกมา -> ลุงจ์คว้า
    "jab5": ("H", [3, 4, 5], GROUND),      # ยัดลงหีบ -> ปิดฝา -> นั่งทับ
    "jab6": ("H", [5, 6, 6], GROUND),      # เด้งออกจากหีบ กางแขนหัวเราะ
